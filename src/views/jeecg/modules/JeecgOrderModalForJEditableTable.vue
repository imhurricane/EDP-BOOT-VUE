  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: '/oa/jeecgOrderMain/add',
          edit: '/oa/jeecgOrderMain/edit',
          orderCustomerList: '/oa/jeecgOrderMain/queryOrderCustomerListByMainId',
          orderTicketList: '/oa/jeecgOrderMain/queryOrderTicketListByMainId'
        }
      }
    },
    created() {
